      ...
      md:!p-12 xs:!p-2 sm:!p-8 pt-16 overflow-hidden"
        >
          <AnimatedText
            ...
            className="inline-block text-dark dark:text-light font-bold w-full capitalize mb-16 md:mb-6 md:!text-3xl !text-6xl !leading-tight lg:!text-6xl sm:!mb-8 sm:!text-3xl xl:text-6xl xs:!text-xl xs:mb-4"
          />
